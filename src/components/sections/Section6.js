...
function Section6() {
  ...
  return (
    <Element name="Courses" className="px-0">
          ...
          <div className="row m-0 justify-content-center">
            <div className="col-12 text-md-center text-">
              ...
              <p className="mt-md-4 mt-3 text-dark px-0">
                Discover the future of AI with us! Join our AI courses and
                embark on a transformative learning experience in the world of
