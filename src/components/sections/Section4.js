...
function Section4() {
  return (
    <Element name="Why Choose Us" className="px-0">
          ...
          <div className="row m-0 justify-content-between">
            ...
            <div className="col-md-9 col-12 al px-md-5 mt-md-0 mt-5">
              ...
              <p className="mt-0 mb-3">
                ...
                partner with Evolving AI, you gain access to a wealth of
                knowledge and insights, both on our Instagram page and our
                Discord server.
              </p>{" "}
              <p className="mt-0 mb-3">
                <span className="fw-bold text-warning">
                ...
                &nbsp;Discord provides a dynamic space for interactive
                engagement, including live chats, voice channels, and exclusive
                events. By partnering with Evolving AI on Discord, brands can
                directly engage with our audience in real-time, creating a more
              ...
              <p className="mt-0 mb-3">
                ...
                message reaches a wider audience and resonates on multiple
                levels.
              </p>{" "}
              <p className="mt-0 mb-3">
                <span className="fw-bold text-warning">
                ...
                &nbsp; Just like on Instagram, we provide data-driven insights
                and analytics on Discord, allowing brands to measure the
                performance and impact of their collaborations effectively. This
                data-driven approach helps brands make informed decisions and
